...
export const Loans = () => {
        ...
        const fetchUserCurrentLoans = async () => {
            if (authState && authState.isAuthenticated) {
                ...
                try {
                    ...
                    setHttpError((error as Error).message); // Proper error handling
                } finally {
    ...
    const returnBook = async (bookId: number) => {
        ...
        try {
            ...
            setCheckout((prevCheckout) => !prevCheckout); // Toggle checkout to refresh UI
        } catch (error) {
    ...
    const renewLoan = async (bookId: number) => {
        ...
        try {
            ...
            setCheckout(!checkout); // Trigger re-fetch of loans
        } catch (error) {
            setHttpError((error as Error).message);
        }
    };
                            ...
                            <div key={shelfCurrentLoan.book.id}>
                                <div className='row mt-3 mb-3'>
                                    <div className='col-4 col-md-4 container'>
                                        <img
                                            src={shelfCurrentLoan.book?.img || require('./../../../Images/BooksImages/book-luv2code-1000.png')}
                                            width='226'
                                            height='349'
                                            alt='Book'
                                        />
                            ...
                            <div key={shelfCurrentLoan.book.id}>
                                <div className='d-flex justify-content-center align-items-center flex-column'>
                                    <img
                                        ...
                                        alt='Book'
                                    />
                                    <h6 className='text-center'>{shelfCurrentLoan.book.title}</h6>
                                    <button
